...
public class VueInscription extends JPanel implements ActionListener {
	...
	public VueInscription(Semi_Marathon semiMarathon)
	{
		...
		infosPaiement.setLayout(new GridLayout(4, 1));
		
		JPanel infosCB = new JPanel();
		infosCB.setLayout(new GridLayout(3, 4));
		
		numCB = new JFormattedTextField(masqueNumCB);
		infosCB.add(new JLabel("Numero carte credit :", SwingConstants.CENTER));
		infosCB.add(numCB);
		infosCB.add(new JLabel()); // Pour cadrage
		infosCB.add(new JLabel()); // Pour cadrage
		
		moisCB = new JFormattedTextField(masqueDateCB);
		infosCB.add(new JLabel("Mois :", SwingConstants.CENTER));
		infosCB.add(moisCB);
		
		anneeCB = new JFormattedTextField(masqueDateCB);
		infosCB.add(new JLabel("Annee :", SwingConstants.CENTER));
		infosCB.add(anneeCB);
		
		criptoCB = new JFormattedTextField(masqueCrypCB);
		infosCB.add(new JLabel("3 derniers chiffres :", SwingConstants.CENTER));
		infosCB.add(criptoCB);
		infosCB.add(new JLabel()); // Pour cadrage
		infosCB.add(new JLabel()); // Pour cadrage
		
		infosPaiement.add(infosCB);
